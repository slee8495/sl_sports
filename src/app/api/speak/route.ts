...
// Neural TTS for the chat assistant's replies, routed through AI Gateway (openai/tts-1-hd)
// instead of the robotic browser Web Speech API. The client falls back to Web Speech if
// this request fails.
